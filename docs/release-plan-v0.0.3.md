...
- [x] **Step 3:** Run `poetry run black src/ tests/` and fix any issues (4 files unchanged)
...
- [x] **Step 7:** Update `CHANGELOG.md` with v0.0.3 release changes (updated)
- [ ] **Step 8:** Commit all changes to main, create tag v0.0.3, push, and create GitHub release
